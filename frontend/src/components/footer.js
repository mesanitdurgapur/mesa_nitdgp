      ...
      <div className="footer-row">
        ...
        <div className="footer-col">
          ...
          <div className="social-links">
            <a href="https://www.linkedin.com/company/mesa-nitdgp/"><i className="fa-brands fa-linkedin" /></a>
            <a href="https://www.instagram.com/mesa_nitdgp?igsh=MXFqaDd5MnR5MGtqNQ%3D%3D"><i className="fa-brands fa-instagram" /></a>
            <a href="https://www.facebook.com/mesanitdurgapur"><i className="fa-brands fa-facebook" /></a>
          </div>
        </div>
      </div>
    </div>
